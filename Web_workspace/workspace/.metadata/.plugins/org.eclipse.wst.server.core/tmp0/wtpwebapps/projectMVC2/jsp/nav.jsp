...
<nav class="navbar bg-body-tertiary">
    <div class="container-fluid">
        ...
        <a class="navbar-brand" href="${pageContext.request.contextPath}/index.jsp">
    		<img src="${pageContext.request.contextPath}/image/home.png" alt="Home" width="30" height="30"/>
		</a>
            ...
            <div class="navbar-nav navigation">
                <ul>
                    ...
                    <li class="list">
                        ...
                        <a class="nav-link" href="${pageContext.request.contextPath}/member/memberWriteForm.jsp">
                            <span class="icon">
                    ...
                    <li class="list">
                        ...
                        <a class="nav-link" href="${pageContext.request.contextPath}/member/memberLoginForm.do">
                            <span class="icon">
                                <ion-icon name="person-outline"></ion-icon> <!-- 사람 아이콘 추가 -->
                            </span>
				    ...
				    <a class="nav-link" href="${pageContext.request.contextPath}/member/memberLogout.do">
				        <span class="icon">
				    ...
				    <a class="nav-link" href="${pageContext.request.contextPath}/member/memberUpdateForm.jsp">
				        <span class="icon">
				    ...
				    <a class="nav-link" href="${pageContext.request.contextPath}/board/boardWriteForm.jsp">
				        <span class="icon">
				    ...
				    <a class="nav-link" href="${pageContext.request.contextPath}/board/list.do?pg=1">
				        <span class="icon">
