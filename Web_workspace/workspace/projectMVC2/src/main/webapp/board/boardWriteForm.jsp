...
<!-- 제목을 중앙에 정렬하고, 클릭 시 메인 페이지(index.do)로 이동하게 설정 -->
<h2 align="center" style="font-family: 'Comic Sans MS';" style="cursor: pointer;" 
	 onclick="location.href='../index.do'" > P o s t </h2>
	 
<!-- 게시글 작성 폼 -->
<!-- 폼의 action 속성은 'boardWrite.do'로 설정되어 있으며, 사용자가 입력한 데이터를 POST 방식으로 전송 -->
<!-- onsubmit 이벤트는 폼 제출 시 validateForm 함수를 호출하여 유효성 검사를 수행 -->
<form action="boardWrite.do" method="post" onsubmit="return validateForm();">
