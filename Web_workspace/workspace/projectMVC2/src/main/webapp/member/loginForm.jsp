...
<link rel="stylesheet" type="text/css" href="/projectMVC2/css/logincss.css" />
</head>
<body>
<h1>
	<img src="../image/4.jpg" width="100" height="100" alt="홈" 
		 onclick="location.href='/projectMVC2/index.do'" style="cursor: pointer;">
	...
	<table border="1">
	    ...
	    <tr>
	    	<td colspan="2" align="center">
	    		...
	    		<input type="button" value="회원가입" onclick="location.href='/projectMVC2/member/writeForm.do'" />      
			...
			$.ajax({
				...
				success: function(data){
					...
					if(data.trim() == 'fail')
						...
						location.href = '/projectMVC2/index.do'; // 메인 페이지로 이동
					}
				},
				error: function(e){
