...
<head>
<!-- favicon & footer -->
<link rel="icon" href="/SpringHotel/resources/static/favicon.ico"
	type="image/x-icon">
					...
					<div class="slider-item">
						<div class="card shadow-sm">
							...
							<div class="card-body">
								...
								<p class="card-text">크기: ${room.size}m² | 수용 인원:
									${room.capacity}명</p>
								<p class="card-text">가격: ₩${room.price}</p>
								<p class="card-text">${room.description}</p>
								<div class="d-flex justify-content-between align-items-center">
									<button class="btn btn-outline-primary"
										onclick="location.href='${pageContext.request.contextPath}/room/detail/${room.roomId}'">상세
										보기</button>
